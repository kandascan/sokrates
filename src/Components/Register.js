                ...
                <div className="row justify-content-center">
                    <div className="col-md-6">
                        <form noValidate className="form-signin" onSubmit={this.handleSubmit}>
                            ...
                            />
                            <button className="btn btn-lg btn-primary btn-block" type="submit">Rejestracja</button>
                        </form>
                    </div>
                </div>
            </div>
...
export default connect(mapStateToProps, { register, clearError })(withRouter(RegisterForm));